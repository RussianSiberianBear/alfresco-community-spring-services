...
/**
 * RU: DTO-модель Alfresco REST API: ResultNode.
 * EN: Alfresco REST API DTO model: ResultNode.
 */
...
public class ResultNode {
     ...
     * <p><strong>RU:</strong> значение поля «search» модели Alfresco REST API. Поле опционально, если конкретный endpoint не требует его явно.</p>

     * <p><strong>EN:</strong> Value of the search field in the Alfresco REST API model. Optional unless a specific endpoint requires it.</p>
     ...
     * <p><strong>RU:</strong> метка версии. Поле опционально, если конкретный endpoint не требует его явно.</p>

     * <p><strong>EN:</strong> Value of the version label field in the Alfresco REST API model. Optional unless a specific endpoint requires it.</p>
    ...
    /**
     * RU: Создаёт экземпляр ResultNode.
     * EN: Creates a ResultNode instance.
     */
    public ResultNode() {
    }
    ...
    public void setIsFavorite(Boolean isFavorite) {
        ...
        /**
     * <p><strong>RU:</strong> Возвращает значение поля «search» модели Alfresco REST API.</p>
     * <p><strong>EN:</strong> Returns Value of the search field in the Alfresco REST API model.</p>
     *
     * @return RU: текущее значение search. EN: current value of search.
     */
    ...
    public SearchEntry getSearch() {
        ...
        /**
     * <p><strong>RU:</strong> Устанавливает значение поля «search» модели Alfresco REST API.</p>
     * <p><strong>EN:</strong> Sets Value of the search field in the Alfresco REST API model.</p>
     *
     * @param search RU: новое значение search. EN: new value for search.
     */
    ...
    public void setArchivedAt(OffsetDateTime archivedAt) {
        ...
        /**
     * <p><strong>RU:</strong> Возвращает метка версии.</p>
     * <p><strong>EN:</strong> Returns Value of the version label field in the Alfresco REST API model.</p>
     *
     * @return RU: текущее значение versionLabel. EN: current value of versionLabel.
     */
    ...
    public String getVersionLabel() {
        ...
        /**
     * <p><strong>RU:</strong> Устанавливает метка версии.</p>
     * <p><strong>EN:</strong> Sets Value of the version label field in the Alfresco REST API model.</p>
     *
     * @param versionLabel RU: новое значение versionLabel. EN: new value for versionLabel.
     */
