...
/**
 * RU: DTO-модель Alfresco REST API: ResultSetRowEntry.
 * EN: Alfresco REST API DTO model: ResultSetRowEntry.
 */
...
public class ResultSetRowEntry {
    ...
    /**
     * RU: Создаёт экземпляр ResultSetRowEntry.
     * EN: Creates a ResultSetRowEntry instance.
     */
