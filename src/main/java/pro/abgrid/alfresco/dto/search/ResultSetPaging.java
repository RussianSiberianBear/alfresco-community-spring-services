...
/**
 * RU: DTO-модель Alfresco REST API: ResultSetPaging.
 * EN: Alfresco REST API DTO model: ResultSetPaging.
 */
...
public class ResultSetPaging {
    ...
    /**
     * RU: Создаёт экземпляр ResultSetPaging.
     * EN: Creates a ResultSetPaging instance.
     */
