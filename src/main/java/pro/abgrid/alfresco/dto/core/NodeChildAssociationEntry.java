...
/**
 * RU: DTO-модель Alfresco REST API: NodeChildAssociationEntry.
 * EN: Alfresco REST API DTO model: NodeChildAssociationEntry.
 */
...
public class NodeChildAssociationEntry {
    ...
    /**
     * RU: Создаёт экземпляр NodeChildAssociationEntry.
     * EN: Creates a NodeChildAssociationEntry instance.
     */
