...
/**
 * RU: DTO-модель Alfresco REST API: RatingEntry.
 * EN: Alfresco REST API DTO model: RatingEntry.
 */
...
public class RatingEntry {
    ...
    /**
     * RU: Создаёт экземпляр RatingEntry.
     * EN: Creates a RatingEntry instance.
     */
    public RatingEntry() {
    }
