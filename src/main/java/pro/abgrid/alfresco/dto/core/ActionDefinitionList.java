...
/**
 * RU: DTO-модель Alfresco REST API: ActionDefinitionList.
 * EN: Alfresco REST API DTO model: ActionDefinitionList.
 */
...
public class ActionDefinitionList {
    ...
    /**
     * RU: Создаёт экземпляр ActionDefinitionList.
     * EN: Creates a ActionDefinitionList instance.
     */
