...
/**
 * RU: DTO-модель Alfresco REST API: SiteGroupPaging.
 * EN: Alfresco REST API DTO model: SiteGroupPaging.
 */
...
public class SiteGroupPaging {
    ...
    /**
     * RU: Создаёт экземпляр SiteGroupPaging.
     * EN: Creates a SiteGroupPaging instance.
     */
