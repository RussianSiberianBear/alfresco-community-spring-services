...
/**
 * RU: DTO-модель Alfresco REST API: ActivityEntry.
 * EN: Alfresco REST API DTO model: ActivityEntry.
 */
...
public class ActivityEntry {
    ...
    /**
     * RU: Создаёт экземпляр ActivityEntry.
     * EN: Creates a ActivityEntry instance.
     */
