...
/**
 * RU: DTO-модель Alfresco REST API: NodeAssociationPaging.
 * EN: Alfresco REST API DTO model: NodeAssociationPaging.
 */
...
public class NodeAssociationPaging {
    ...
    /**
     * RU: Создаёт экземпляр NodeAssociationPaging.
     * EN: Creates a NodeAssociationPaging instance.
     */
