...
/**
 * RU: DTO-модель Alfresco REST API: SiteMemberEntry.
 * EN: Alfresco REST API DTO model: SiteMemberEntry.
 */
...
public class SiteMemberEntry {
    ...
    /**
     * RU: Создаёт экземпляр SiteMemberEntry.
     * EN: Creates a SiteMemberEntry instance.
     */
