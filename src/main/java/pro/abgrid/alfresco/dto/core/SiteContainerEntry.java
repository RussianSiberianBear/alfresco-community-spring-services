...
/**
 * RU: DTO-модель Alfresco REST API: SiteContainerEntry.
 * EN: Alfresco REST API DTO model: SiteContainerEntry.
 */
...
public class SiteContainerEntry {
     ...
     */
    private SiteContainer entry;

    /**
     * RU: Создаёт экземпляр SiteContainerEntry.
     * EN: Creates a SiteContainerEntry instance.
     */
    public SiteContainerEntry() {
    }
