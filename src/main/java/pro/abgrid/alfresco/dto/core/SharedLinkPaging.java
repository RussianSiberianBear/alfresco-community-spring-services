...
/**
 * RU: DTO-модель Alfresco REST API: SharedLinkPaging.
 * EN: Alfresco REST API DTO model: SharedLinkPaging.
 */
...
public class SharedLinkPaging {
    ...
    /**
     * RU: Создаёт экземпляр SharedLinkPaging.
     * EN: Creates a SharedLinkPaging instance.
     */
    public SharedLinkPaging() {
    }
