...
/**
 * RU: DTO-модель Alfresco REST API: NodeAssociation.
 * EN: Alfresco REST API DTO model: NodeAssociation.
 */
...
public class NodeAssociation {
    ...
    /**
     * RU: Создаёт экземпляр NodeAssociation.
     * EN: Creates a NodeAssociation instance.
     */
