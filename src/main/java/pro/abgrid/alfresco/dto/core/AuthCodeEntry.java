...
/**
 * RU: DTO-модель Alfresco REST API: AuthCodeEntry.
 * EN: Alfresco REST API DTO model: AuthCodeEntry.
 */
...
public class AuthCodeEntry {
    ...
    /**
     * RU: Создаёт экземпляр AuthCodeEntry.
     * EN: Creates a AuthCodeEntry instance.
     */
