...
/**
 * RU: DTO-модель Alfresco REST API: AuditAppEntry.
 * EN: Alfresco REST API DTO model: AuditAppEntry.
 */
...
public class AuditAppEntry {
    ...
    /**
     * RU: Создаёт экземпляр AuditAppEntry.
     * EN: Creates a AuditAppEntry instance.
     */
