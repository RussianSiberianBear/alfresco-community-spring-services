...
/**
 * RU: DTO-модель Alfresco REST API: ChildAssociation.
 * EN: Alfresco REST API DTO model: ChildAssociation.
 */
...
public class ChildAssociation {
    ...
    /**
     * RU: Создаёт экземпляр ChildAssociation.
     * EN: Creates a ChildAssociation instance.
     */
