...
/**
 * RU: DTO-модель Alfresco REST API: RenditionEntry.
 * EN: Alfresco REST API DTO model: RenditionEntry.
 */
...
public class RenditionEntry {
    ...
    /**
     * RU: Создаёт экземпляр RenditionEntry.
     * EN: Creates a RenditionEntry instance.
     */
