...
/**
 * RU: DTO-модель Alfresco REST API: GroupPaging.
 * EN: Alfresco REST API DTO model: GroupPaging.
 */
...
public class GroupPaging {
    ...
    /**
     * RU: Создаёт экземпляр GroupPaging.
     * EN: Creates a GroupPaging instance.
     */
    public GroupPaging() {
    }
