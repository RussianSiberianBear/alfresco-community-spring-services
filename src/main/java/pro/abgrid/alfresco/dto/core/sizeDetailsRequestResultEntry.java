...
/**
 * RU: DTO-модель Alfresco REST API: sizeDetailsRequestResultEntry.
 * EN: Alfresco REST API DTO model: sizeDetailsRequestResultEntry.
 */
...
public class sizeDetailsRequestResultEntry {
    ...
    /**
     * RU: Создаёт экземпляр sizeDetailsRequestResultEntry.
     * EN: Creates a sizeDetailsRequestResultEntry instance.
     */
