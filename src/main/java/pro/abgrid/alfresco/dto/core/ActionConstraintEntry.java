...
/**
 * RU: DTO-модель Alfresco REST API: ActionConstraintEntry.
 * EN: Alfresco REST API DTO model: ActionConstraintEntry.
 */
...
public class ActionConstraintEntry {
    ...
    /**
     * RU: Создаёт экземпляр ActionConstraintEntry.
     * EN: Creates a ActionConstraintEntry instance.
     */
