...
/**
 * RU: DTO-модель Alfresco REST API: PersonNetworkPaging.
 * EN: Alfresco REST API DTO model: PersonNetworkPaging.
 */
...
public class PersonNetworkPaging {
    ...
    /**
     * RU: Создаёт экземпляр PersonNetworkPaging.
     * EN: Creates a PersonNetworkPaging instance.
     */
    public PersonNetworkPaging() {
    }
