...
/**
 * RU: DTO-модель Alfresco REST API: SiteContainerPaging.
 * EN: Alfresco REST API DTO model: SiteContainerPaging.
 */
...
public class SiteContainerPaging {
    ...
    /**
     * RU: Создаёт экземпляр SiteContainerPaging.
     * EN: Creates a SiteContainerPaging instance.
     */
    public SiteContainerPaging() {
    }
