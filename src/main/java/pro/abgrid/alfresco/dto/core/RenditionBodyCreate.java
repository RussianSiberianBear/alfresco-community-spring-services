...
/**
 * RU: DTO-модель Alfresco REST API: RenditionBodyCreate.
 * EN: Alfresco REST API DTO model: RenditionBodyCreate.
 */
...
public class RenditionBodyCreate {
    ...
    /**
     * RU: Создаёт экземпляр RenditionBodyCreate.
     * EN: Creates a RenditionBodyCreate instance.
     */
