...
/**
 * RU: DTO-модель Alfresco REST API: PersonPaging.
 * EN: Alfresco REST API DTO model: PersonPaging.
 */
...
public class PersonPaging {
    ...
    /**
     * RU: Создаёт экземпляр PersonPaging.
     * EN: Creates a PersonPaging instance.
     */
    public PersonPaging() {
    }
