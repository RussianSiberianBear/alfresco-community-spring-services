...
/**
 * RU: DTO-модель Alfresco REST API: VersionPaging.
 * EN: Alfresco REST API DTO model: VersionPaging.
 */
...
public class VersionPaging {
    ...
    /**
     * RU: Создаёт экземпляр VersionPaging.
     * EN: Creates a VersionPaging instance.
     */
