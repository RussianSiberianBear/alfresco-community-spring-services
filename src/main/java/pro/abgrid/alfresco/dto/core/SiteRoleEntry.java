...
/**
 * RU: DTO-модель Alfresco REST API: SiteRoleEntry.
 * EN: Alfresco REST API DTO model: SiteRoleEntry.
 */
...
public class SiteRoleEntry {
     ...
     */
    private SiteRole entry;

    /**
     * RU: Создаёт экземпляр SiteRoleEntry.
     * EN: Creates a SiteRoleEntry instance.
     */
    public SiteRoleEntry() {
    }
