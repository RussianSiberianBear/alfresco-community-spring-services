...
/**
 * RU: DTO-модель Alfresco REST API: FavoritePaging.
 * EN: Alfresco REST API DTO model: FavoritePaging.
 */
...
public class FavoritePaging {
    ...
    /**
     * RU: Создаёт экземпляр FavoritePaging.
     * EN: Creates a FavoritePaging instance.
     */
