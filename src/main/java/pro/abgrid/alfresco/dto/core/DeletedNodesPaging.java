...
/**
 * RU: DTO-модель Alfresco REST API: DeletedNodesPaging.
 * EN: Alfresco REST API DTO model: DeletedNodesPaging.
 */
...
public class DeletedNodesPaging {
    ...
    /**
     * RU: Создаёт экземпляр DeletedNodesPaging.
     * EN: Creates a DeletedNodesPaging instance.
     */
