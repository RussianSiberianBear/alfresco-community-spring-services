...
/**
 * RU: DTO-модель Alfresco REST API: DownloadEntry.
 * EN: Alfresco REST API DTO model: DownloadEntry.
 */
...
public class DownloadEntry {
    ...
    /**
     * RU: Создаёт экземпляр DownloadEntry.
     * EN: Creates a DownloadEntry instance.
     */
