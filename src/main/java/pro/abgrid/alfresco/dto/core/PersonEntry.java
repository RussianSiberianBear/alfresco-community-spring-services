...
/**
 * RU: DTO-модель Alfresco REST API: PersonEntry.
 * EN: Alfresco REST API DTO model: PersonEntry.
 */
...
public class PersonEntry {
    ...
    /**
     * RU: Создаёт экземпляр PersonEntry.
     * EN: Creates a PersonEntry instance.
     */
    public PersonEntry() {
    }
