...
/**
 * RU: DTO-модель Alfresco REST API: SiteGroupEntry.
 * EN: Alfresco REST API DTO model: SiteGroupEntry.
 */
...
public class SiteGroupEntry {
    ...
    /**
     * RU: Создаёт экземпляр SiteGroupEntry.
     * EN: Creates a SiteGroupEntry instance.
     */
