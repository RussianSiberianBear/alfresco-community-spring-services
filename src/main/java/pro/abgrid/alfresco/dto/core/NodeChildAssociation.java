...
/**
 * RU: DTO-модель Alfresco REST API: NodeChildAssociation.
 * EN: Alfresco REST API DTO model: NodeChildAssociation.
 */
...
public class NodeChildAssociation {
    ...
    /**
     * RU: Создаёт экземпляр NodeChildAssociation.
     * EN: Creates a NodeChildAssociation instance.
     */
    public NodeChildAssociation() {
    }
