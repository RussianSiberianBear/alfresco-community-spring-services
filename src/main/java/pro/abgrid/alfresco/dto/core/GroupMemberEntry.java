...
/**
 * RU: DTO-модель Alfresco REST API: GroupMemberEntry.
 * EN: Alfresco REST API DTO model: GroupMemberEntry.
 */
...
public class GroupMemberEntry {
    ...
    /**
     * RU: Создаёт экземпляр GroupMemberEntry.
     * EN: Creates a GroupMemberEntry instance.
     */
