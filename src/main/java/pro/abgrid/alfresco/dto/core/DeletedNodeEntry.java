...
/**
 * RU: DTO-модель Alfresco REST API: DeletedNodeEntry.
 * EN: Alfresco REST API DTO model: DeletedNodeEntry.
 */
...
public class DeletedNodeEntry {
    ...
    /**
     * RU: Создаёт экземпляр DeletedNodeEntry.
     * EN: Creates a DeletedNodeEntry instance.
     */
