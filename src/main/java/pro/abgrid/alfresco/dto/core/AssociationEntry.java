...
/**
 * RU: DTO-модель Alfresco REST API: AssociationEntry.
 * EN: Alfresco REST API DTO model: AssociationEntry.
 */
...
public class AssociationEntry {
    ...
    /**
     * RU: Создаёт экземпляр AssociationEntry.
     * EN: Creates a AssociationEntry instance.
     */
