...
/**
 * RU: DTO-модель Alfresco REST API: AssociationBody.
 * EN: Alfresco REST API DTO model: AssociationBody.
 */
...
public class AssociationBody {
    ...
    /**
     * RU: Создаёт экземпляр AssociationBody.
     * EN: Creates a AssociationBody instance.
     */
