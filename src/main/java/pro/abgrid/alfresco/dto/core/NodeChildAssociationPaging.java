...
/**
 * RU: DTO-модель Alfresco REST API: NodeChildAssociationPaging.
 * EN: Alfresco REST API DTO model: NodeChildAssociationPaging.
 */
...
public class NodeChildAssociationPaging {
    ...
    /**
     * RU: Создаёт экземпляр NodeChildAssociationPaging.
     * EN: Creates a NodeChildAssociationPaging instance.
     */
    public NodeChildAssociationPaging() {
    }
