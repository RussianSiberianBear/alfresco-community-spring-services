...
/**
 * RU: DTO-модель Alfresco REST API: CategoryEntry.
 * EN: Alfresco REST API DTO model: CategoryEntry.
 */
...
public class CategoryEntry {
    ...
    /**
     * RU: Создаёт экземпляр CategoryEntry.
     * EN: Creates a CategoryEntry instance.
     */
