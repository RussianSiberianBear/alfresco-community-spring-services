...
/**
 * RU: DTO-модель Alfresco REST API: CommentPaging.
 * EN: Alfresco REST API DTO model: CommentPaging.
 */
...
public class CommentPaging {
    ...
    /**
     * RU: Создаёт экземпляр CommentPaging.
     * EN: Creates a CommentPaging instance.
     */
