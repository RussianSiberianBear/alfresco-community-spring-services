...
/**
 * RU: DTO-модель Alfresco REST API: PersonBodyCreate.
 * EN: Alfresco REST API DTO model: PersonBodyCreate.
 */
...
public class PersonBodyCreate {
     ...
     * <p><strong>EN:</strong> Value of the password field in the Alfresco REST API model. Required by the Swagger schema.</p>
    ...
    /**
     * RU: Создаёт экземпляр PersonBodyCreate.
     * EN: Creates a PersonBodyCreate instance.
     */
