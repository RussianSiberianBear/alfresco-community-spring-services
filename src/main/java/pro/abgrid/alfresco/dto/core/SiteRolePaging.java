...
/**
 * RU: DTO-модель Alfresco REST API: SiteRolePaging.
 * EN: Alfresco REST API DTO model: SiteRolePaging.
 */
...
public class SiteRolePaging {
    ...
    /**
     * RU: Создаёт экземпляр SiteRolePaging.
     * EN: Creates a SiteRolePaging instance.
     */
