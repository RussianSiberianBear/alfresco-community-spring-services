...
/**
 * RU: DTO-модель Alfresco REST API: Person.
 * EN: Alfresco REST API DTO model: Person.
 */
...
public class Person {
     ...
     * <p><strong>RU:</strong> значение поля «first name» модели Alfresco REST API. Обязательное поле Swagger schema.</p>

     * <p><strong>EN:</strong> Value of the first name field in the Alfresco REST API model. Required by the Swagger schema.</p>
     ...
     * <p><strong>RU:</strong> значение поля «display name» модели Alfresco REST API. Поле опционально, если конкретный endpoint не требует его явно.</p>

     * <p><strong>EN:</strong> Value of the display name field in the Alfresco REST API model. Optional unless a specific endpoint requires it.</p>
     ...
     * <p><strong>RU:</strong> значение поля «avatar id» модели Alfresco REST API. Поле опционально, если конкретный endpoint не требует его явно.</p>

     * <p><strong>EN:</strong> Value of the avatar id field in the Alfresco REST API model. Optional unless a specific endpoint requires it.</p>
     ...
     * <p><strong>RU:</strong> значение поля «email» модели Alfresco REST API. Обязательное поле Swagger schema.</p>

     * <p><strong>EN:</strong> Value of the email field in the Alfresco REST API model. Required by the Swagger schema.</p>
     ...
     * <p><strong>RU:</strong> значение поля «status updated at» модели Alfresco REST API. Поле опционально, если конкретный endpoint не требует его явно.</p>

     * <p><strong>EN:</strong> Value of the status updated at field in the Alfresco REST API model. Optional unless a specific endpoint requires it.</p>
     ...
     * <p><strong>RU:</strong> значение поля «enabled» модели Alfresco REST API. Обязательное поле Swagger schema.</p>

     * <p><strong>EN:</strong> Value of the enabled field in the Alfresco REST API model. Required by the Swagger schema.</p>
     ...
     * <p><strong>RU:</strong> значение поля «capabilities» модели Alfresco REST API. Поле опционально, если конкретный endpoint не требует его явно.</p>

     * <p><strong>EN:</strong> Value of the capabilities field in the Alfresco REST API model. Optional unless a specific endpoint requires it.</p>
    ...
    /**
     * RU: Создаёт экземпляр Person.
     * EN: Creates a Person instance.
     */
    public Person() {
    }
    ...
    public void setDescription(String description) {
        ...
        /**
     * <p><strong>RU:</strong> Возвращает значение поля «avatar id» модели Alfresco REST API.</p>
     * <p><strong>EN:</strong> Returns Value of the avatar id field in the Alfresco REST API model.</p>
     *
     * @return RU: текущее значение avatarId. EN: current value of avatarId.
     */
    ...
    public String getAvatarId() {
        ...
        /**
     * <p><strong>RU:</strong> Устанавливает значение поля «avatar id» модели Alfresco REST API.</p>
     * <p><strong>EN:</strong> Sets Value of the avatar id field in the Alfresco REST API model.</p>
     *
     * @param avatarId RU: новое значение avatarId. EN: new value for avatarId.
     */
    ...
    public void setTelephone(String telephone) {
        ...
        /**
     * <p><strong>RU:</strong> Возвращает значение поля «status updated at» модели Alfresco REST API.</p>
     * <p><strong>EN:</strong> Returns Value of the status updated at field in the Alfresco REST API model.</p>
     *
     * @return RU: текущее значение statusUpdatedAt. EN: current value of statusUpdatedAt.
     */
    ...
    public OffsetDateTime getStatusUpdatedAt() {
        ...
        /**
     * <p><strong>RU:</strong> Устанавливает значение поля «status updated at» модели Alfresco REST API.</p>
     * <p><strong>EN:</strong> Sets Value of the status updated at field in the Alfresco REST API model.</p>
     *
     * @param statusUpdatedAt RU: новое значение statusUpdatedAt. EN: new value for statusUpdatedAt.
     */
    ...
    public void setProperties(Map<String, Object> properties) {
        ...
        /**
     * <p><strong>RU:</strong> Возвращает значение поля «capabilities» модели Alfresco REST API.</p>
     * <p><strong>EN:</strong> Returns Value of the capabilities field in the Alfresco REST API model.</p>
     *
     * @return RU: текущее значение capabilities. EN: current value of capabilities.
     */
    ...
    public Capabilities getCapabilities() {
        ...
        /**
     * <p><strong>RU:</strong> Устанавливает значение поля «capabilities» модели Alfresco REST API.</p>
     * <p><strong>EN:</strong> Sets Value of the capabilities field in the Alfresco REST API model.</p>
     *
     * @param capabilities RU: новое значение capabilities. EN: new value for capabilities.
     */
