...
/**
 * RU: DTO-модель Alfresco REST API: CascadingDictList.
 * EN: Alfresco REST API DTO model: CascadingDictList.
 */
...
public class CascadingDictList {
    ...
    /**
     * RU: Создаёт экземпляр CascadingDictList.
     * EN: Creates a CascadingDictList instance.
     */
