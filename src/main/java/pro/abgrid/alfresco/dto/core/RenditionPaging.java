...
/**
 * RU: DTO-модель Alfresco REST API: RenditionPaging.
 * EN: Alfresco REST API DTO model: RenditionPaging.
 */
...
public class RenditionPaging {
    ...
    /**
     * RU: Создаёт экземпляр RenditionPaging.
     * EN: Creates a RenditionPaging instance.
     */
