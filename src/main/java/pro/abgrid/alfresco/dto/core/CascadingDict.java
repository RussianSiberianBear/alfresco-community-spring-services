...
/**
 * RU: DTO-модель Alfresco REST API: CascadingDict.
 * EN: Alfresco REST API DTO model: CascadingDict.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class CascadingDict {
    /**
     ...
     * <p><strong>RU:</strong> значение поля «data» модели Alfresco REST API. Поле опционально, если конкретный endpoint не требует его явно.</p>

     * <p><strong>EN:</strong> Value of the data field in the Alfresco REST API model. Optional unless a specific endpoint requires it.</p>
    ...
    /**
     * RU: Создаёт экземпляр CascadingDict.
     * EN: Creates a CascadingDict instance.
     */
    public CascadingDict() {
    }
     ...
     * <p><strong>EN:</strong> Returns Value of the data field in the Alfresco REST API model.</p>
     *
     ...
     * <p><strong>EN:</strong> Sets Value of the data field in the Alfresco REST API model.</p>
     *
