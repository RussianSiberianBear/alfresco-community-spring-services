...
/**
 * RU: DTO-модель Alfresco REST API: SiteMembershipRequestPaging.
 * EN: Alfresco REST API DTO model: SiteMembershipRequestPaging.
 */
...
public class SiteMembershipRequestPaging {
    ...
    /**
     * RU: Создаёт экземпляр SiteMembershipRequestPaging.
     * EN: Creates a SiteMembershipRequestPaging instance.
     */
    public SiteMembershipRequestPaging() {
    }
