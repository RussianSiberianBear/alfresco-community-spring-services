...
/**
 * RU: DTO-модель Alfresco REST API: GroupMemberPaging.
 * EN: Alfresco REST API DTO model: GroupMemberPaging.
 */
...
public class GroupMemberPaging {
    ...
    /**
     * RU: Создаёт экземпляр GroupMemberPaging.
     * EN: Creates a GroupMemberPaging instance.
     */
