...
/**
 * RU: DTO-модель Alfresco REST API: SiteMembershipRequestEntry.
 * EN: Alfresco REST API DTO model: SiteMembershipRequestEntry.
 */
...
public class SiteMembershipRequestEntry {
    ...
    /**
     * RU: Создаёт экземпляр SiteMembershipRequestEntry.
     * EN: Creates a SiteMembershipRequestEntry instance.
     */
