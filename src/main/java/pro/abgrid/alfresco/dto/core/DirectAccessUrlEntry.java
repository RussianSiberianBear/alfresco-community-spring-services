...
/**
 * RU: DTO-модель Alfresco REST API: DirectAccessUrlEntry.
 * EN: Alfresco REST API DTO model: DirectAccessUrlEntry.
 */
...
public class DirectAccessUrlEntry {
    ...
    /**
     * RU: Создаёт экземпляр DirectAccessUrlEntry.
     * EN: Creates a DirectAccessUrlEntry instance.
     */
