...
/**
 * RU: DTO-модель Alfresco REST API: NodeBodyMove.
 * EN: Alfresco REST API DTO model: NodeBodyMove.
 */
...
public class NodeBodyMove {
    ...
    /**
     * RU: Создаёт экземпляр NodeBodyMove.
     * EN: Creates a NodeBodyMove instance.
     */
    public NodeBodyMove() {
    }
