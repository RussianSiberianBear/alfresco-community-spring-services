...
/**
 * RU: DTO-модель Alfresco REST API: CascadingDictCreateEntry.
 * EN: Alfresco REST API DTO model: CascadingDictCreateEntry.
 */
...
public class CascadingDictCreateEntry {
    ...
    /**
     * RU: Создаёт экземпляр CascadingDictCreateEntry.
     * EN: Creates a CascadingDictCreateEntry instance.
     */
