...
/**
 * RU: DTO-модель Alfresco REST API: NodeAssociationEntry.
 * EN: Alfresco REST API DTO model: NodeAssociationEntry.
 */
...
public class NodeAssociationEntry {
    ...
    /**
     * RU: Создаёт экземпляр NodeAssociationEntry.
     * EN: Creates a NodeAssociationEntry instance.
     */
