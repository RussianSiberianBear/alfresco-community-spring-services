...
/**
 * RU: DTO-модель Alfresco REST API: CommentEntry.
 * EN: Alfresco REST API DTO model: CommentEntry.
 */
...
public class CommentEntry {
    ...
    /**
     * RU: Создаёт экземпляр CommentEntry.
     * EN: Creates a CommentEntry instance.
     */
    public CommentEntry() {
    }
