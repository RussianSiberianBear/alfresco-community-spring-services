...
/**
 * RU: DTO-модель Alfresco REST API: SiteMembershipRequest.
 * EN: Alfresco REST API DTO model: SiteMembershipRequest.
 */
...
public class SiteMembershipRequest {
    ...
    /**
     * RU: Создаёт экземпляр SiteMembershipRequest.
     * EN: Creates a SiteMembershipRequest instance.
     */
